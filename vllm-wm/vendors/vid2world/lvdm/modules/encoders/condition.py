...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def encode_with_transformer(self, text):
        ...
        batch_first = self._uses_batch_first_attention()
        if not batch_first:
    ...
    def _uses_batch_first_attention(self) -> bool:
        try:
            return bool(self.model.transformer.resblocks[0].attn.batch_first)
        except Exception:
            return False
...
class FrozenOpenCLIPImageEmbedderV2(AbstractEncoder):
    ...
    def encode_with_vision_transformer(self, x):
        ...
        if not self._uses_batch_first_visual_transformer():
            x = x.permute(1, 0, 2)  # NLD -> LND
    ...
    def _uses_batch_first_visual_transformer(self) -> bool:
        try:
            return bool(self.model.visual.transformer.resblocks[0].attn.batch_first)
        except Exception:
            return False
