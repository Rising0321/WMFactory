...
***This is the SFT version of InternVL3-2B, which has undergone native multimodal pre-trainin and SFT but has not undergone MPO. If you're unsure which version to use, please use the [InternVL3-2B](https://huggingface.co/OpenGVLab/InternVL3-2B) version.***
